...
void DirectXPage::SetMenuOverlay(int level, Platform::String^ objective, float timeLimit, float bonusTime)
{
	
}

void DirectXPage::SetPauseOverlay()
{

}

void DirectXPage::SetGameOverOverlay(bool win, int maxLevel, int highScore)
{
	
}

void DirectXPage::SetLoadingOverlay()
{
	
}

void DirectXPage::HideGameOverlay()
{
	
}

void DirectXPage::pauseButtonTapped(Object^ sender, TappedRoutedEventArgs^ args)
{
	pauseButton->Visibility = ::Visibility::Collapsed;
	m_app->SetGameEngineState(GameEngineState::Pause);
}